...
public class MatchNames extends Configured implements Tool {
  ...
  public static final String S3_PATH = "s3://datasets.elasticmapreduce/ngrams/books/20090715/eng-us-all/%sgram/data";
    ...
    for (String i : Arrays.asList("2", "3")) {
		  FileInputFormat.addInputPath(job, new Path(String.format(S3_PATH, i)));
    }
